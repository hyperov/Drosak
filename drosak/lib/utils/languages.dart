...
class Languages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      LocalizationKeys.phone_confirmation: 'you will receive a confirmation code on your phone',
      ...
      LocalizationKeys.app_login: 'Login',
    ...
    'ar_EG': {
      ...
      LocalizationKeys.app_login: 'تسجيل الدخول',
