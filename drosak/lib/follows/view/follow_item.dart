        ...
        children: [
              ...
              Positioned(
                child: Container(
                  ...
                  child: Row(children: [
                    ...
                    Text(followsViewModel.follows[index].rating.toString(),
                        style:
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  followsViewModel.follows[index].teacherName,
                  maxLines: 2,
          ...
          ElevatedButton.icon(
            onPressed: () {
              openDeleteDialog(
                  followsViewModel, followsViewModel.follows[index].teacherId);
            },
            icon: const Icon(
              Icons.done,
